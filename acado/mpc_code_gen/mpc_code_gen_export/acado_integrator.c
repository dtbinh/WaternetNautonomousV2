...
out[5] = ((((real_t)(8.0000000000000004e-01)*(u[0]-u[1]))-((real_t)(1.0000000000000000e+03)*xd[5]))/(real_t)(5.0000000000000000e+02));
}
...
out[10] = ((xd[3]*a[4])-(xd[4]*a[5]));
out[11] = a[6];
out[12] = ((real_t)(0.0000000000000000e+00)-a[7]);
...
out[21] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00));
...
out[45] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+03))*a[11]);
out[46] = ((real_t)(8.0000000000000004e-01)*a[12]);
out[47] = (((real_t)(-8.0000000000000004e-01))*a[12]);
}
...
acadoWorkspace.rk_xxx[18] = rk_eta[66];
acadoWorkspace.rk_xxx[19] = rk_eta[67];
acadoWorkspace.rk_xxx[20] = rk_eta[68];
acadoWorkspace.rk_xxx[21] = rk_eta[69];
acadoWorkspace.rk_xxx[22] = rk_eta[70];
acadoWorkspace.rk_xxx[23] = rk_eta[71];
acadoWorkspace.rk_xxx[24] = rk_eta[72];
acadoWorkspace.rk_xxx[25] = rk_eta[73];
acadoWorkspace.rk_xxx[26] = rk_eta[74];
acadoWorkspace.rk_xxx[27] = rk_eta[75];
acadoWorkspace.rk_xxx[28] = rk_eta[76];
acadoWorkspace.rk_xxx[29] = rk_eta[77];
acadoWorkspace.rk_xxx[30] = rk_eta[78];
acadoWorkspace.rk_xxx[31] = rk_eta[79];
acadoWorkspace.rk_xxx[32] = rk_eta[80];
acadoWorkspace.rk_xxx[33] = rk_eta[81];
acadoWorkspace.rk_xxx[34] = rk_eta[82];
acadoWorkspace.rk_xxx[35] = rk_eta[83];
acadoWorkspace.rk_xxx[36] = rk_eta[84];
acadoWorkspace.rk_xxx[37] = rk_eta[85];
acadoWorkspace.rk_xxx[38] = rk_eta[86];
acadoWorkspace.rk_xxx[39] = rk_eta[87];
acadoWorkspace.rk_xxx[40] = rk_eta[88];
acadoWorkspace.rk_xxx[41] = rk_eta[89];
acadoWorkspace.rk_xxx[42] = rk_eta[90];
acadoWorkspace.rk_xxx[43] = rk_eta[91];
acadoWorkspace.rk_xxx[44] = rk_eta[92];
acadoWorkspace.rk_xxx[45] = rk_eta[93];
acadoWorkspace.rk_xxx[46] = rk_eta[94];
acadoWorkspace.rk_xxx[47] = rk_eta[95];
acadoWorkspace.rk_xxx[48] = rk_eta[96];
acadoWorkspace.rk_xxx[49] = rk_eta[97];
acadoWorkspace.rk_xxx[50] = rk_eta[98];
acadoWorkspace.rk_xxx[51] = rk_eta[99];
acadoWorkspace.rk_xxx[52] = rk_eta[100];
acadoWorkspace.rk_xxx[53] = rk_eta[101];
acadoWorkspace.rk_xxx[54] = rk_eta[102];
acadoWorkspace.rk_xxx[55] = rk_eta[103];
acadoWorkspace.rk_xxx[56] = rk_eta[104];
acadoWorkspace.rk_xxx[57] = rk_eta[105];
...
acadoWorkspace.rk_diffsNew2[(i * 8) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.2500000000000000e-01 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.2500000000000000e-01;
}
}
for (run1 = 0; run1 < 2; ++run1)
{
...
for (i = 0; i < 6; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 8) + (run1 + 6)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.2500000000000000e-01 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.2500000000000000e-01;
}
}
