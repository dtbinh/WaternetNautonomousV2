...
{
    /* vector of size 7 */
    FORCESNLPsolver_FLOAT xinit[7];

    /* vector of size 500 */
    FORCESNLPsolver_FLOAT x0[500];

    /* vector of size 2700 */
    FORCESNLPsolver_FLOAT all_parameters[2700];
