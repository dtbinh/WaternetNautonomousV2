classdef LogGPS < robotics.ros.Message
    %LogGPS MATLAB implementation of nautonomous_logging_msgs/LogGPS
    ...
    properties (Constant)
        MessageType = 'nautonomous_logging_msgs/LogGPS' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '4a8f574bbf8acd357f61d69d1f5a73c3' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Header', 'Latitude', 'Longitude', 'Mac', 'Name', 'Token'} % List of non-constant message properties
        ROSPropertyList = {'header', 'latitude', 'longitude', 'mac', 'name', 'token'} % List of non-constant ROS message properties
    end
    
    methods
        function obj = LogGPS(msg)
            %LogGPS Construct the message object LogGPS
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'LogGPS', 'Header');
        ...
        function set.Name(obj, name)
            ...
            validateattributes(name, {'char'}, {}, 'LogGPS', 'Name');
        ...
        function set.Mac(obj, mac)
            ...
            validateattributes(mac, {'char'}, {}, 'LogGPS', 'Mac');
        ...
        function set.Token(obj, token)
            ...
            validateattributes(token, {'char'}, {}, 'LogGPS', 'Token');
        ...
        function set.Latitude(obj, latitude)
            ...
            validateattributes(latitude, {'numeric'}, {'nonempty', 'scalar'}, 'LogGPS', 'Latitude');
        ...
        function set.Longitude(obj, longitude)
            ...
            validateattributes(longitude, {'numeric'}, {'nonempty', 'scalar'}, 'LogGPS', 'Longitude');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.nautonomous_logging_msgs.LogGPS.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.nautonomous_logging_msgs.LogGPS;
            obj.reload(strObj);
        end
    end
end
