classdef State < robotics.ros.Message
    %State MATLAB implementation of nautonomous_state_msgs/State
    ...
    properties (Constant)
        MessageType = 'nautonomous_state_msgs/State' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'c79f0d88a7597db980a56d7ac144c654' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Pose', 'Twist'} % List of non-constant message properties
        ROSPropertyList = {'pose', 'twist'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'State', 'Pose');
        ...
        function set.Twist(obj, twist)
            ...
            validateattributes(twist, {obj.GeometryMsgsTwistClass}, {'nonempty', 'scalar'}, 'State', 'Twist');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.nautonomous_state_msgs.State.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.nautonomous_state_msgs.State;
            obj.reload(strObj);
        end
    end
end
