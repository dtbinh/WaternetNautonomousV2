 ...
 * 
 *  Matrix containing 15 reference/measurement vectors of size 8 for first 15 nodes.
 */
real_t y[ 120 ];
...
/** Matrix of size: 720 x 2 (row major format) */
real_t E[ 1440 ];
...
/** Matrix of size: 15 x 30 (row major format) */
real_t A[ 450 ];
