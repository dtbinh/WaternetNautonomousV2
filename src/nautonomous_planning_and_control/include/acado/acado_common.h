...
/** Matrix of size: 2 x 80 (row major format) */
...
/** Matrix of size: 440 x 2 (row major format) */
real_t E[ 880 ];
...
/** Matrix of size: 20 x 8 (row major format) */
real_t H10[ 160 ];
...
/** Matrix of size: 10 x 20 (row major format) */
real_t A[ 200 ];
