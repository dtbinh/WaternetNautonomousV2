...
void waypoint_cb(const nautonomous_mpc_msgs::StageVariable::ConstPtr& waypoint_msg)
{
	waypoint_marker.pose.position.x = waypoint_msg->x;
	waypoint_marker.pose.position.y = waypoint_msg->y;
...
int main(int argc, char **argv)
{
	...
	waypoint_sub = 		nh.subscribe<nautonomous_mpc_msgs::StageVariable>("/mission_coordinator/reference_state",10,waypoint_cb);
	...
	waypoint_marker.header.frame_id = obstacle_marker.header.frame_id = "/my_frame";
	waypoint_marker.header.stamp = obstacle_marker.header.stamp = ros::Time::now();
	obstacle_marker.ns = "points_and_lines";
	waypoint_marker.ns = "waypoints";
	waypoint_marker.action = obstacle_marker.action = visualization_msgs::Marker::ADD;
	waypoint_marker.pose.orientation.w = obstacle_marker.pose.orientation.w = 1.0;
    	waypoint_marker.id = obstacle_marker.id = 0;
