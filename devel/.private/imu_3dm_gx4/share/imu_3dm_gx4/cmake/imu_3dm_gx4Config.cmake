...
if("TRUE" STREQUAL "TRUE")
  set(imu_3dm_gx4_SOURCE_PREFIX /home/waternet/programmeren/nautonomous/WaternetNautonomousV2/src/nautonomous_sensor_imu_razor/imu_3dm_gx4)
  set(imu_3dm_gx4_DEVEL_PREFIX /home/waternet/programmeren/nautonomous/WaternetNautonomousV2/devel/.private/imu_3dm_gx4)
  ...
  set(imu_3dm_gx4_INSTALL_PREFIX /home/waternet/programmeren/nautonomous/WaternetNautonomousV2/install)
...
if(NOT "/home/waternet/programmeren/nautonomous/WaternetNautonomousV2/devel/.private/imu_3dm_gx4/include " STREQUAL " ")
  set(imu_3dm_gx4_INCLUDE_DIRS "")
  set(_include_dirs "/home/waternet/programmeren/nautonomous/WaternetNautonomousV2/devel/.private/imu_3dm_gx4/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'imu_3dm_gx4' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'gcross <gcross.code@icloud.com>, Kartik Mohta <kartikmohta@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'imu_3dm_gx4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/waternet/programmeren/nautonomous/WaternetNautonomousV2/src/nautonomous_sensor_imu_razor/imu_3dm_gx4/${idir}'.  Ask the maintainer 'gcross <gcross.code@icloud.com>, Kartik Mohta <kartikmohta@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/waternet/programmeren/nautonomous/WaternetNautonomousV2/devel/.private/imu_3dm_gx4/lib;/home/waternet/programmeren/nautonomous/WaternetNautonomousV2/devel/lib;/opt/ros/kinetic/lib)
