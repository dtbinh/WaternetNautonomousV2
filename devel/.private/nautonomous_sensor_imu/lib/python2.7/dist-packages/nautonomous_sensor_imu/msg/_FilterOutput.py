...
"""autogenerated by genpy from nautonomous_sensor_imu/FilterOutput.msg. Do not edit."""
import sys
...
class FilterOutput(genpy.Message):
  ...
  _type = "nautonomous_sensor_imu/FilterOutput"
...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2H4d().pack(_x.quat_status, _x.bias_status, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w))
      buff.write(_get_struct_9d().pack(*self.orientation_covariance))
      _x = self
      buff.write(_get_struct_3d().pack(_x.bias.x, _x.bias.y, _x.bias.z))
      buff.write(_get_struct_9d().pack(*self.bias_covariance))
      _x = self
      buff.write(_get_struct_2H().pack(_x.bias_covariance_status, _x.orientation_covariance_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.quat_status, _x.bias_status, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w,) = _get_struct_2H4d().unpack(str[start:end])
      start = end
      end += 72
      ...
      self.bias_covariance = _get_struct_9d().unpack(str[start:end])
      _x = self
      start = end
      end += 4
      (_x.bias_covariance_status, _x.orientation_covariance_status,) = _get_struct_2H().unpack(str[start:end])
      return self
