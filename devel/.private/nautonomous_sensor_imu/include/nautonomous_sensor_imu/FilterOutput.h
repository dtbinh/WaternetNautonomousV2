// Generated by gencpp from file nautonomous_sensor_imu/FilterOutput.msg
// DO NOT EDIT!


#ifndef NAUTONOMOUS_SENSOR_IMU_MESSAGE_FILTEROUTPUT_H
#define NAUTONOMOUS_SENSOR_IMU_MESSAGE_FILTEROUTPUT_H
...
namespace nautonomous_sensor_imu
{
...
struct FilterOutput_
{
  ...
  typedef boost::shared_ptr< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> const> ConstPtr;

}; // struct FilterOutput_

typedef ::nautonomous_sensor_imu::FilterOutput_<std::allocator<void> > FilterOutput;

typedef boost::shared_ptr< ::nautonomous_sensor_imu::FilterOutput > FilterOutputPtr;
typedef boost::shared_ptr< ::nautonomous_sensor_imu::FilterOutput const> FilterOutputConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'nautonomous_sensor_imu': ['/home/waternet/programmeren/nautonomous/WaternetNautonomousV2/src/nautonomous_sensor_imu_razor/msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> >
{
  ...
  static const char* value(const ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x40af8b09da9b33d0ULL;
  static const uint64_t static_value2 = 0x2fc6b6288f52b159ULL;
};

template<class ContainerAllocator>
struct DataType< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nautonomous_sensor_imu::FilterOutput_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // NAUTONOMOUS_SENSOR_IMU_MESSAGE_FILTEROUTPUT_H
