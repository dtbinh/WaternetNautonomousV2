...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /home/waternet/programmeren/nautonomous/WaternetNautonomousV2/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /home/waternet/programmeren/nautonomous/WaternetNautonomousV2/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /home/waternet/programmeren/nautonomous/WaternetNautonomousV2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/waternet/programmeren/nautonomous/WaternetNautonomousV2/build/catkin_tools_prebuild/${idir}'.  Ask the maintainer 'jbohren <jbo@jhu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/waternet/programmeren/nautonomous/WaternetNautonomousV2/devel/.private/catkin_tools_prebuild/lib;/home/waternet/programmeren/nautonomous/WaternetNautonomousV2/devel/lib;/opt/ros/kinetic/lib)
